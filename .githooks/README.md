...
This directory contains Git hooks for the TIMGCPSMOPERATOR project.
...
**Example:**
```bash
# Edit api/v1alpha1/timgcpsmsecret_types.go
vim api/v1alpha1/timgcpsmsecret_types.go

# Commit - hook automatically updates CRDs
git add api/v1alpha1/timgcpsmsecret_types.go
git commit -m "feat: add new field to TimGcpSmSecret"
