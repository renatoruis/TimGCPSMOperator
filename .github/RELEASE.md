...
- `timgcpsmsecret-crd.yaml`, `timgcpsmsecretconfig-crd.yaml`
...
```
ghcr.io/renatoruis/timgcpsmoperator:v1.0.0
ghcr.io/renatoruis/timgcpsmoperator:latest
```
...
```bash
# Build Docker image
docker build -t ghcr.io/renatoruis/timgcpsmoperator:v1.0.0 .
docker push ghcr.io/renatoruis/timgcpsmoperator:v1.0.0
